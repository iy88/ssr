  ...
  async get(event) {
    ...
    if(this.state.ip !== null){
      try{
        ...
        if(data.data.isIPv4){
          let {data} = this.state.ip === '0.0.0.0' ? await axios.get('https://iy88.site:433/openapi/ipRegion') : await axios.get('https://iy88.site:433/openapi/ipRegion?ip='+this.state.ip);
